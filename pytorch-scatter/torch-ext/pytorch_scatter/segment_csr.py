...
def segment_sum_csr(src: torch.Tensor, indptr: torch.Tensor,
    ...
    return ops.segment_sum_csr(src, indptr, out)
...
def segment_mean_csr(src: torch.Tensor, indptr: torch.Tensor,
                     out: Optional[torch.Tensor] = None) -> torch.Tensor:
    return ops.segment_mean_csr(src, indptr, out)
...
def segment_min_csr(
    ...
    return ops.segment_min_csr(src, indptr, out)
...
def segment_max_csr(
    ...
    return ops.segment_max_csr(src, indptr, out)
...
def gather_csr(src: torch.Tensor, indptr: torch.Tensor,
               out: Optional[torch.Tensor] = None) -> torch.Tensor:
    return ops.gather_csr(src, indptr, out)
