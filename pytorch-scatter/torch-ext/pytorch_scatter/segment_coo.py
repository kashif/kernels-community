...
def segment_sum_coo(src: torch.Tensor, index: torch.Tensor,
    ...
    return ops.segment_sum_coo(src, index, out, dim_size)
...
def segment_mean_coo(src: torch.Tensor, index: torch.Tensor,
                     out: Optional[torch.Tensor] = None,
                     dim_size: Optional[int] = None) -> torch.Tensor:
    return ops.segment_mean_coo(src, index, out, dim_size)
...
def segment_min_coo(
    ...
    return ops.segment_min_coo(src, index, out, dim_size)
...
def segment_max_coo(
        ...
        out: Optional[torch.Tensor] = None,
        dim_size: Optional[int] = None) -> Tuple[torch.Tensor, torch.Tensor]:
    return ops.segment_max_coo(src, index, out, dim_size)
...
def gather_coo(src: torch.Tensor, index: torch.Tensor,
    ...
    return ops.gather_coo(src, index, out)
